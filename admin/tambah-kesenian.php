...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm bg-light">
        <div class="container-fluid">
            ...
            <a class="navbar-brand fw-bold" href="index.php">Kesenian</a>
    ...
    <div class="offcanvas offcanvas-start bg-purple text-white sidebar-nav" tabindex="-1" id="offcanvasExample"
        ...
        <div class="offcanvas-body pt-3 p-0">
          ...
          <li class="nav-link bordered px-3">
            <a href="adminuser.php" class="nav-link px-3">
    ...
    <main class="mt-3 p-2">
        <div class="container">
            <div class="page-title">
                <div style="font-weight: 500;" class="fs-3">Tambah Kesenian</div>
            </div>
            <nav class="mt-2 mb-4" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="#">Kesenian</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Tambah Kesenian</li>
                </ol>
            </nav>
                    ...
                    <div class="card-body">
                        ...
                        <form action="proses_tambahwisata.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3 px-2">
                                        <label for="st_name" class="form-label">Nama Kesenian</label>
                                        <input class="form-control" placeholder="Masukkan Nama Kesenian" type="text"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3 px-2">
                                        <label for="st_email" class="form-label">Harga</label>
                                ...
                                <div class="col-md-4 mt-md-4">
                                    <div class="mb-3 px-2">
                                        <label for="st_admsn" class="form-label">Email Resmi Kesenian</label>
